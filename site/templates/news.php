...
<header class="container">
    ...
    <div class="mt-6">
        <figure class="js-coverlay group relative rounded-lg overflow-hidden">
                ...
                <div class="flex flex-col <?php e(count($images) < 3, 'lg:flex-row ') ?> justify-center">
                    ...
                    <div class="js-lightbox <?php e(count($images) < 3, 'lg:mt-10 mb-8 lg:mb-0 ') ?><?php e(count($images) < 3, 'lg:ml-12 lg:flex lg:flex-col ') ?>flex-none text-center">
                        ...
                        <?php
                            ...
                            if ($image) :
                        ?>
                        <div class="js-coverlay <?php e(count($images) > 2, 'm-2 xs:sm-4 ') ?>inline-block <?php e(count($images) === 2, 'last:ml-6 lg:last:ml-0 lg:last:mt-6 ') ?>rounded-lg group relative overflow-hidden select-none">
                            <div class="inset-0 w-full h-full absolute rounded-lg bg-gradient-to-tr from-red-medium to-orange-medium z-20"></div>
