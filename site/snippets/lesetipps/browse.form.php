<section class="container">
    <?= $page->details()->kt() ?>
    <form class="w-full mb-6 pl-4 pr-2 py-2 bg-orange-light border-4 border-dashed border-orange-medium rounded-lg flex justify-between items-center relative">
        <input
    ...
    <div class="flex justify-around">
        ...
        <div class="block flex-none text-right">
            <a class="inline-block h-full flex items-center px-4 rounded-lg text-white text-shadow bg-red-light hover:bg-red-medium transition-all" href="<?= $page->url() ?>" title="<?= t('Alles zurücksetzen') ?>">
                <span class="sketch text-xl sm:text-3xl select-none">RESET</span>
            </a>
        </div>
    </div>
